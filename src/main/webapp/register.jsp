	...
	$(document).ready(function() {
		$("#registerForm").validationEngine("attach");
			$("#registerForm").submit(function(e){
			    ...
			    $("#registerForm").addClass('relative');
			    $.ajax({
			        url : formURL,
			        type: "POST",
			        data : postData,
	...
	<div id="registerBox" class="loading">
		<form id="registerForm" action="/register.html" name="registerForm" method="post" >
			...
			<input class="validate[required,custom[onlyLetterSp]]" type="text"
				name="account.firstName" id="firstname" placeholder="First name" /><br /> <input
			...
			<input type="radio" name="account.gender" value="male" checked="checked">Male <input type="radio" name="sex" value="female">Female <br /><br /> 
			<input class="validate[required,custom[email]]" type="text" name="account.email" id="email" placeholder="Email" /><br /> 
			<input class="button" type="submit" value="Register" id="registerButton"/>
